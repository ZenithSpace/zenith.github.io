                ...
                >
                    {partners.map((partner, index) => (
                        <motion.a
                            ...
                            className="group relative flex items-center justify-center p-6 bg-white/5 rounded-xl border border-white/10 hover:border-zenith-sub/50 transition-all duration-300 hover:bg-white/10 w-64 flex-shrink-0 z-10 h-32"
                        >
                            {partner.logo ? (
                                <img
                                    src={partner.logo}
                                    alt={partner.name}
                                    className="max-h-full max-w-full w-auto h-auto object-contain opacity-70 group-hover:opacity-100 transition-opacity duration-300 grayscale group-hover:grayscale-0"
                                />
                            ) : (
                                <span className="text-white/50 group-hover:text-zenith-sub font-bold text-lg text-center transition-colors duration-300">
