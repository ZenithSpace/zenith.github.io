...
export const partnersData: Partner[] = [
    ...
    { name: 'Korea Foundation for Science and Creativity', logo: '/assets/partners/kofac.jpg', link: 'https://www.kofac.re.kr/' },
    { name: 'Soksok Camp', logo: '/assets/partners/soksok.png', link: 'https://apply.kosac.re.kr/' },
